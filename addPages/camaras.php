...
<body>
  ...
  <section class="containerCamsVigilancia">
    ...
    <div class="servInstalacionContainerImgs">
      <img class="servInstalacionImg" src="/images/camaras/imagenesInicio/primera.png" alt="">
    </div>
  </section>

  <!-- DETALLES Y ESPECIFICACIONES -->
  <section class="detailsEspecificacionesContainer">
    ...
    <div class="servInstalacionContainerImgs">
      <img class="servInstalacionImg" src="/images/camaras/imagenesInicio/segundo.png" alt="">
    </div>
  </section>
  ...
  <section class="servInstalacionContainer">
    ...
    <div class="servInstalacionContainerImgs">
      <img class="servInstalacionImg" src="/images/camaras/servInstalacion.png" alt="">
    </div>
  ...
  <!-- MAS GUSTADOS -->
  <section class="masGustadosContainer">
  ...
  <section class="ofertasContainer">
    <h2 class="ofertasTitle">Ofertas y Promociones</h2>
